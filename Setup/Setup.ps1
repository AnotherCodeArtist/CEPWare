Write-Host "Welcome to CEPWARE. This is the automated setup. Before you run this script. Please do a docker-compose up. `n Please follow the instructions and be patient until everything is setup"
